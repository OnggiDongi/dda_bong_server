...
public enum ErrorCode {
	...
	NOTFOUND_REVIEW(103, "해당 리뷰를 찾을 수 없습니다."),
	NOTFOUND_ACTIVITY_POST(104, "해당 활동 게시글을 찾을 수 없습니다."),
	NOTFOUND_CERTIFICATION(105, "해당 인증서를 찾을 수 없습니다."),
	...
	BAD_REQUEST_ACTIVITY_NOT_COMPLETED(206, "아직 완료되지 않은 활동입니다."),
