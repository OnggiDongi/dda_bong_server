...
(1, 5, 5, 5, '성실하고 착한 봉사자입니다.', 1,1, 1),
(2, 4, 4, 4, '열정적인 모습이 보기 좋았습니다.', 2,1, 1),
(3, 5, 4, 5, '시간 약속을 잘 지킵니다.', 3,1, 1),
(4, 3, 4, 3, '조금 더 적극적으로 참여했으면 좋겠습니다.', 4,1, 1),
(5, 5, 5, 5, '항상 웃는 얼굴로 봉사에 임합니다.', 5,3, 1),
(6, 4, 5, 4, '책임감이 강하고 꼼꼼합니다.', 6,2, 1),
(7, 5, 4, 5, '친화력이 좋아 다른 봉사자들과 잘 어울립니다.', 7,4, 1),
(8, 4, 4, 4, '묵묵히 자기 역할을 다합니다.', 8,3, 1),
(9, 5, 5, 5, '솔선수범하는 모습이 인상적입니다.', 9,5, 1),
